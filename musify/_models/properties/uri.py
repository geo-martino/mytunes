...
from musify._models.metadata import UniqueAttribute, Attribute
from musify._types import StrippedString, TO_SET, HttpURL
from musify.exception import MusifyTypeError
from .._base import RootModel, BaseModel
...
class URI(RootModel[str]):
    ...
    def _validate_unavailable[T](cls, value: T, info: ValidationInfo) -> T | str:
        from musify._models._context import RemoteModelContext  # avoid circular import
