...
from musify._models import ResourceModel, AttributeModel
...
from musify._models.collection._base import CollectionModel, RemoteCollection
from musify._models.collection._sync import SYNC_TYPE, get_sync_items
...
if TYPE_CHECKING:
    from musify._models.api.playlist import HasPlaylistEndpoints, PlaylistReadEndpoints, \
