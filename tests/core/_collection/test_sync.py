...
from mytunes.core._collection._sync import get_sync_items, get_sync_items_for_add, get_sync_items_for_refresh, \
...
def test_get_sync_items_calls_expected_getter():
    with (
        patch(f"{MODULE_ROOT}.core._collection._sync.get_sync_items_for_add") as mock_add,
        patch(f"{MODULE_ROOT}.core._collection._sync.get_sync_items_for_refresh") as mock_refresh,
        patch(f"{MODULE_ROOT}.core._collection._sync.get_sync_items_for_sync") as mock_sync,
    ):
