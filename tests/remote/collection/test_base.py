...
class TestItemsCursor(MusifyModelTester):
    @pytest.fixture
    ...
    def test_set_limit_to_current_url(self, model: ItemsCursor, faker: Faker) -> None:
        model.limit = None
    ...
    def test_set_offset_to_current_url(self, model: ItemsCursor, faker: Faker) -> None:
        model.offset = None
    ...
    def test_reset(self, model: ItemsCursor, faker: Faker) -> None:
