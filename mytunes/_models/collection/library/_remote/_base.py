...
from mytunes._models.collection.album import RemoteAlbumCollection
from mytunes._models.collection.artist import RemoteArtistCollection
from mytunes._models.collection.library import Library
from mytunes._models.collection.library._remote._result import RemoteTracksResult, RemoteArtistsResult, \
    RemoteAlbumsResult, RemotePlaylistsResult
from mytunes._models.collection.playlist import RemotePlaylist
from mytunes._models.item.album import RemoteAlbum, HasAlbums
from mytunes._models.item.artist import RemoteArtist, HasArtists
from mytunes._models.item.genre import RemoteGenre, HasGenres
