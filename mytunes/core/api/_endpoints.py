...
class BatchReadEndpoints[UT: URI, RT: RemoteResource](Endpoints[UT, RT]):
    ...
    @overload
    async def get_many(self, uris: Sequence[_URI_TYPE[RT]], limit: PositiveInt | None = None) -> list[RT]: ...

    @overload
    async def get_many(self, uris: Sequence[UT], limit: PositiveInt | None = None) -> list[RT]: ...
